...
## Proceso de búsqueda de textos

path = 'data/constitucion_vigente/'
...
## Procesamiento para llevar a dataframe
...
## Importando markdowns propuesta

path = "data/propuesta_constitucion/"
filelist = os.listdir(path)
filelist.sort()
...
df.to_csv('data/processed/constitucion_propuesta.csv', index=False)